...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "Biblioteca de componentes React reutilizáveis com TypeScript, incluindo botões, cards, inputs e modais.",
      image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg",
      technologies: ["React", "TypeScript", "Tailwind CSS", "Storybook"],
      liveUrl: "#",
      githubUrl: "#",
      featured: false,
      isComponentShowcase: true,
    },
    {
      id: 5,
  ...
  return (
    <section id="projects" className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-sm lg:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  {project.image && (project.image !== "/api/placeholder/600/400" || project.isComponentShowcase) ? (
                    <div className="relative w-full h-64 overflow-hidden">
                      {project.isComponentShowcase ? (
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    {project.isComponentShowcase ? (
                      ...
                      >
                        <span>🧩</span>
                        <span className="text-sm">Ver Componentes</span>
                      </button>
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center space-x-3">
                  {selectedProject.isComponentShowcase && (
      ...
      {showComponentShowcase && (
        <ComponentShowcase onClose={() => setShowComponentShowcase(false)} />
      )}
    </section>
  );
};
