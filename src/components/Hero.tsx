const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 md:pt-32 pb-16">
        {/* Conteúdo principal */}
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-right">
            <div className="relative">
              ...
              <div className="absolute -inset-10 bg-[radial-gradient(circle_at_50%_50%,rgba(168,85,247,0.35),transparent_60%)] blur-2xl" />
              <img
                src="/logo.png"
                alt="Beloni"
                className="relative w-[280px] sm:w-[360px] lg:w-[430px] h-auto drop-shadow-[0_25px_45px_rgba(168,85,247,0.25)] select-none"
                draggable={false}
              />
            </div>
          </div>
        ...
        <div className="mt-14 lg:mt-16">
          <div className="relative overflow-visible">
            ...
            <div
              className="absolute -inset-10 bg-[radial-gradient(circle_at_50%_35%,rgba(255,255,255,0.12),transparent_55%)] blur-2xl pointer-events-none"
              aria-hidden="true"
            />
            <div
              className="absolute -inset-12 bg-[radial-gradient(circle_at_50%_45%,rgba(168,85,247,0.22),transparent_60%)] blur-3xl pointer-events-none"
              aria-hidden="true"
            />
            {/* Sombra no “chão” */}
            <div
            ...
            <img
              ...
              className="relative w-full h-auto block drop-shadow-[0_35px_90px_rgba(0,0,0,0.65)]"
              draggable={false}
              loading="lazy"
            />
          </div>
