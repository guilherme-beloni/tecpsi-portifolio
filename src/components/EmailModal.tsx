    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gray-800 rounded-2xl max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
        <div className="p-8 text-center">
          ...
          <div className="mb-6">
            {isSuccess && (
              <div className="w-20 h-20 mx-auto bg-[#22415f]/35 rounded-full flex items-center justify-center animate-pulse">
                <div className="w-12 h-12 bg-[#22415f] rounded-full flex items-center justify-center">
          ...
          <h3 className={`text-2xl font-bold mb-4 ${
            isSuccess ? 'text-[#ffeafc]' : 'text-red-400'
          }`}>
          ...
          <button
            ...
            className={`w-full px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 ${
              isSuccess 
                ? 'bg-[#22415f] hover:bg-[#2d5478] text-white' 
